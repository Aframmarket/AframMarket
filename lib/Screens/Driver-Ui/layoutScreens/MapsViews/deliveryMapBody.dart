                          ...
                          children: [
                            ...
                            SizedBox(
                              child: Column(
                                ...
                                children: [
                                  UiText(text: "Food Dot", textColor: AppColors.darkTxt, fontSize: 14, fontWeight: FontWeight.w400),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  UiText(text: "Ordered at 06 Sept, 10:00pm", textColor: AppColors.greyTxt4, fontSize: 12, fontWeight: FontWeight.w400),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  UiText(text: "2x Pepper", textColor: AppColors.greyTxt4, fontSize: 12, fontWeight: FontWeight.w400),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  UiText(text: "1x Brama Fish", textColor: AppColors.greyTxt4, fontSize: 12, fontWeight: FontWeight.w400),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  UiText(text: "ID: #32053", textColor: AppColors.darkTxt7, fontSize: 13, fontWeight: FontWeight.w400),
                                ],
                              ),
                            )
                          ],
                            ...
                            children: [
                              ...
                              SizedBox(
                                child: Row(
                                  ...
                                  children: [
                                    ImageIcon(AssetImage("assets/call_Icon.png")),
                                    ImageIcon(AssetImage("assets/chat_Icon.png")),
                                  ],
                                ),
                              ),
                            ],
